...
|Designing good solutuion with VMs|<table><tr><th>Terminology</th><th>Description</th><th>Azure VMs</th></tr><tr><td>Availability</td><td><sub>Are the applications available when your users need them?</td><td><sub>Availabilty Sets and Scale Sets</td></tr><tr>    <td>Scalability</td><td><sub>Can we handle a growth in users, traffic, or data size without any drop in performance?</td><td><sub>VM Size, Scale Sets and </br> Load balancers</td>  </tr><tr><td>Resilience</td><td><sub>Ability of system to provide acceptable behaviour even when on or more parts of the system fail</td><td><sub>Scale Sets and Load balancers</td></tr><tr><td>Geo-distribution</td><td><sub>Distribute applications across regions and zones</td><td><sub>Scale Sets and Load balancers</td></tr><tr><td>Disaster Recovery</td><td><sub>How to keep your systems running in face of disasters?</td><td><sub>Site Recovery</td></tr><tr><td>Managing Costs</td><td><sub>You want to keep costs low</td><td><sub>Auto scaling Elasticity), Reservations,</br> Spot Instances</td></tr><tr><td>Security</td><td><sub>Secure your VMs</td><td><sub>Dedicated Hosts etc..</td></tr></table>|
|VM Scenarios|<table><tr><th>Scenario</th><th>Solution</th></tr><tr><td><sub>How can you automatically scale up and down VMs?</td><td>VM Scale Sets</td></tr><tr><td><sub>How can you protect VMs from datacenter failures?</td><td><sub>Deploy them to multiple AZs (Scale Sets)</td></tr><tr><td><sub>How much availablity do you get by deploying two or more VM instances in two or more AZs in the same region?</td><td>99.99%</td></tr><tr><td><sub>How can you perform disaster recovery for your VM?</td><td>Site Recovery</td></tr><tr><td><sub>How can you reduce costs for VMs?</td><td><sub>Auto Scaling (Elasticity), Reserved & Spot Instances, Right Region - Cost varies from region to region</td></tr><tr><td><sub>Will you be billed if you stop a VM</td><td>Yes. For Storage. </br> It is a good practice to delete resources </br> that aren't required</td></tr><tr><td><sub>Will two VMs of same size always cost the same?</td><td>No. Price changes with time. Price also is different in different regions</td></tr><tr><td><sub>How can you know who performed a specific action on?</td><td>Activity logs (kept for 90 days) </br> Virtual Machines -> Activity log</td></tr>
</table>| 
 </font> 
