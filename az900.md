...
|Azure DDoS|Large scale attacks to bring your apps down. App goes down or become slow. </br> Hige bill because of unlimited auto scaling </br> two Azure DDos offerings: <li> DDos Protection **Basic:** </br>Protects against common network layer attacks. </br> intelligently identifies and blocks DDos attacks </br>Enabled by default with no extra costs. <li> DDoS Protection **Standard:** </br> Enable for additional cost </br>Mitigares 60 different DDoS attack types </br>Provides attack analytics, metrics, alerting and reporting </br> Get quick support from DDoS Protection Rapid Response (DRR) team </br>Get a Cost gurantee (Recieve service credit if DDoS attack wasn't prevented abd results in scale out </br> Enable it on the Azure virtual network|
|VPN gateway||
|azure ExpressRoute||
