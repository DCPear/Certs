...
|Load balance |</sub><sub>Typically have front end and a back end</sub><sub><sup>  public ip address is the front end. Requests received to the frontend are routed to the backend. Backend pools are the scale set. </sup></sub>|
