...
|Machine Learning Scenarios|<table><tr><th>Scenario</th><th>Solution</th></tr><tr><th>Virtual agent that talk with humans like a human</th><th>Azure bot service</th></tr><tr><th>Identify objects in a video</th><th>Azure Cognitive Services(Vision Services)</th></tr><tr><th>Automate creation of custom ML models</th><th>Azure machine learning</th></tr><tr><th>Help Dta scientists and AI engineers create complex ML models</th><th>Azure machine learning</th></tr></table>| |
 ...
 ### DevOps
 <font size="1">
 Getting better at @Three Elements of Great Software Teams. </Br>Business,  Development, Operations</br>
 Agile brought Buisness and Development together. DevOps brought all three of them together.</br>

 * Communication - Get teams together. <li>Feedback- Earlier you find a problem, easier it is to fix.
 * Automation - Automate testing, infrastructure provisioning, deployment, and monitoring.  <br/><br/>

 **DevOps-CI,CD** </br>  e.g. Code Commit -> Unit Tests ->Integration Tests ->Package ->Deploy ->Automated Tests ->Testing Approval ->Deploy Next </br>
 * Continuous Integration - continuously run your tests and packaging
 * Continuous Deployment - continuously deploy to test environments
 * Contnuous Delievry - continuously deploy to production <br/><br/>

 **Azure DevOps- CI, CD Tools**
 * Azure Repos - private source control (Git) </br> Alternative: GitHub for private and private source control (recently MS bought GitHub).
 * Azure Pipelines - Orchestrate CI/CD pipelines. </br> Alterenative: GitHub actions.
 *  Azure Boards - Scrum, Agile and Kanban boards
 * Azure Artifacts - Artifact repository to store artifacts
 * Azure test Plans - Automation Test tool to check software quality </br> integate it into your CI/CD pipelines<br/><br/>

**Infrastructure as Code IAAC** </br>
...
* Track your infrastructure changes overtime(version control)
* Bring repeatability into your infrastructure
*  Two key parts </br>
    **1. Infrastructure Provisioning-** </br>
    *  provisioning compute, database, storage and networking. 
    * cloud neutral infrastructure provisioning tool - Terraform
    * The recommended Azure service for infrastructure for code - Azure Resource Manager Templates -ARM (can also use Powershell or Azure CLI automation)</br>

    **2. Infrastructure Provisioning-**
    *  Install right software and tolls on the provisioned resources 
    * Open Source Tools - Chef, Puppet, Ansible

**ARM** 
Deployment and management service for Azure.  The ways you can create Azure resources. 
* Azure portal
* Azure powershell - SDKs
* Azure CLI - SDKs
* REST clients

All actions to any resource inAzure go through ARM.

 **ARM Templates**  
 Define resources ina JSON file 
 * Advantages: 
    *  Avoid configuration drift,
    *  Avoid mistakes with manual configuration 
    *  Think of it as version control for your environments
 * Declarative approach to infrastructure code:
    ...
    *  PowerShell and Bash canalso be used for IaaC.
        * But they need step by step instructions
            * 1:Do this
            * 2:Do that ...
        * And they don2t handle failures very well
