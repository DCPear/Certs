...
|Designing good solutuion with VMs|<table><tr><th>Terminology</th><th>Description</th><th>Azure VMs</th></tr><tr><td>Availability</td><td><sub>Are the applications available when your users need them?</td><td><sub>Availabilty Sets and Scale Sets</td></tr><tr>    <td>Scalability</td><td><sub>Can we handle a growth in users, traffic, or data size without any drop in performance?</td><td><sub>VM Size, Scale Sets and </br> Load balancers</td>  </tr><tr><td>Resilience</td><td><sub>Ability of system to provide acceptable behaviour even when on or more parts of the system fail</td><td><sub>Scale Sets and Load balancers</td></tr><tr><td>Geo-distribution</td><td><sub>Distribute applications across regions and zones</td><td><sub>Scale Sets and Load balancers</td></tr><tr><td>Disaster Recovery</td><td><sub>How to keep your systems running in face of disasters?</td><td>Site Recovery</td></tr><tr><td>Managing Costs</td><td><sub>You want to keep costs low</td><td><sub>Auto scaling Elasticity), Reservations,</br> Spot Instances</td></tr><tr><td>Security</td><td><sub>Secure your VMs</td><td><sub>Dedicated Hosts etc..</td></tr></table>|
