...
|(PAAS)Azure container instances|<li> Manage and run simple container based applications <li>**You DO NOT** need to provision and manage VMs <li> Start containers in seconds <li>Azure App service also supports deploying simple containers|
...
|(PAAS)AKS and Service Fabric|AKS: Managed Kubenetes service - create Kubenetes cluster, specify Primary node pool, node size, node count, then deploy the application </br> Azure service Fabric: Microsoft container orchestrator - create service Fabric cluster|
