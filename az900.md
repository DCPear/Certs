...
|Azure Storage </br> Data redundancy|<table><tr><th>Option</th><th>Redundancy</th></tr><tr><td>Locally redundant</br> storage (LRS)</td><td>Three synchornous copies in the same data center. </br> Lease expensive and least availability</td></tr><tr><td>Zone-redundant </br> storage (ZRS)</td><td>Three synchornous copies in the AZs in the primary region.</td></tr><tr><td>Geo-redundant </br> storage (GRS)</td><td>LRS + Asynchornous copy to secondary region(3 more copies using LRS)</td></tr></tr><tr><td>Geo-zone-redundant </br> storage (GZRS)</td><td>ZRS + Asynchornous copy to secondary region(3 more copies using LRS)</br>Most expensive and highest available.</td></tr></table>|
|Azure Disk Storage||
 </font> 
