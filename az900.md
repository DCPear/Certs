...
|Installing nginx on Azure VM|<pre>#!/bin/sh </br>sudo su</br>apr-get -y update </br>apt-get -y install nginx </br>echo "Getting started with Azure Virtual Machines">/var/ww/htnl/index.html </br>echo "Welcome to Azure $(whoami)">/var/ww/htnl/index.html </br>echo "Welcome to Azure $(hostname)">/var/ww/htnl/index.html</pre>|
|Cloud Init Script||
